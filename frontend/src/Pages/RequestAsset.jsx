...
const AssetRequestForm = () => {
    const [input, setInput] = useState({
        ...
        requiredByDate: "",
        status: "",
        requestDate: new Date().toISOString().split('T')[0], // Default to today's date (YYYY-MM-DD format)
        assetName: "",
    ...
    const submitHandler = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(
                "http://localhost:3030/AssetRequest/createreq-asset", // Replace with actual backend URL
                requestData
            );
